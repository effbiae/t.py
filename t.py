import a;import n;from p import p;import numpy as np;import sys;P=a.P;Y=open('Y').read().split()
...
exprs=lambda:(g:=('(2)','!2','^2','&2'),x:=[c+t for t in g for c in a.P[1:a.P.find('S')+1]],x+[f'({u})'+a for u in g for a in x])[-1]
def mis(x,s,t):
